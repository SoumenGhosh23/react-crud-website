    ...
    render() {
        return (
            <>
                ...
                {(this.state.isRegistration == true) ? <Registration /> :
                    <>
      ...
      <button className="signin-button" onClick={this.handleSubmit}>Login</button>
      <div className="link">
        Not Registered? Click 🔽
        <button className="signin-button" onClick={() => this.registration()}>Registration</button>
      </div>
    </div>
    </div>
                    </>
